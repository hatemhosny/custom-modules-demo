...
var A = (r, e, t, c) => {
  if ((e && typeof e == 'object') || typeof e == 'function')
    for (let a of T(e))
      !N.call(r, a) &&
        a !== t &&
        l(r, a, { get: () => e[a], enumerable: !(c = E(e, a)) || c.enumerable });
  return r;
};
var D = (r, e, t) => (
  (t = r != null ? S(R(r)) : {}),
  A(e || !r || !r.__esModule ? l(t, 'default', { value: r, enumerable: !0 }) : t, r)
);
var _ = y((i) => {
  'use strict';
  var h = p('react');
  ...
  var u = h.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
  function s(r, e) {
    if (r === 'font') return '';
  ...
  i.preinit = function (r, e) {
    if (typeof r == 'string' && e && typeof e.as == 'string') {
      var t = e.as,
        ...
        g = typeof e.fetchPriority == 'string' ? e.fetchPriority : void 0;
      t === 'style'
        ? n.d.S(r, typeof e.precedence == 'string' ? e.precedence : void 0, {
            crossOrigin: c,
            integrity: a,
            fetchPriority: g,
          })
...
var d = D(v()),
  ...
  K = d.default ?? d;
export {
  H as __DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,
  I as createPortal,
  K as default,
  b as flushSync,
  F as preconnect,
